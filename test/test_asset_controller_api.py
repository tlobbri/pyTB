...
class TestAssetControllerApi(unittest.TestCase):
    ...
    def test_get_assets_by_entity_group_id_using_get(self):
        """Test case for get_assets_by_entity_group_id_using_get
    ...
    def test_get_user_assets_using_get(self):
        """Test case for get_user_assets_using_get
