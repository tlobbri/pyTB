...
class SigFoxIntegrationControllerApi(object):
    ...
    def process_request_using_post3(self, body, request_headers, routing_key, **kwargs):  # noqa: E501
        """processRequest  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.process_request_using_post3(body, request_headers, routing_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.process_request_using_post3_with_http_info(body, request_headers, routing_key, **kwargs)  # noqa: E501
        else:
            (data) = self.process_request_using_post3_with_http_info(body, request_headers, routing_key, **kwargs)  # noqa: E501
            return data

    def process_request_using_post3_with_http_info(self, body, request_headers, routing_key, **kwargs):  # noqa: E501
        """processRequest  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.process_request_using_post3_with_http_info(body, request_headers, routing_key, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `process_request_using_post3`")  # noqa: E501
        # verify the required parameter 'request_headers' is set
        if ('request_headers' not in params or
                params['request_headers'] is None):
