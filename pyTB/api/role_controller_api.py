...
class RoleControllerApi(object):
    ...
    def get_roles_using_get(self, limit, **kwargs):  # noqa: E501
        """getRoles  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_roles_using_get(limit, async_req=True)
        >>> result = thread.get()
        ...
        :return: TextPageDataRole
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_roles_using_get_with_http_info(limit, **kwargs)  # noqa: E501
        else:
            (data) = self.get_roles_using_get_with_http_info(limit, **kwargs)  # noqa: E501
            return data

    def get_roles_using_get_with_http_info(self, limit, **kwargs):  # noqa: E501
        """getRoles  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_roles_using_get_with_http_info(limit, async_req=True)
        >>> result = thread.get()
        ...
        if ('limit' not in params or
            ...
            raise ValueError("Missing the required parameter `limit` when calling `get_roles_using_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/roles{?type,textSearch,idOffset,textOffset,limit}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='TextPageDataRole',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
