...
class EventControllerApi(object):
    ...
    def get_events_using_get(self, entity_type, entity_id, event_type, tenant_id, limit, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_events_using_get(entity_type, entity_id, event_type, tenant_id, limit, async_req=True)
        >>> result = thread.get()
    ...
    def get_events_using_get_with_http_info(self, entity_type, entity_id, event_type, tenant_id, limit, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_events_using_get_with_http_info(entity_type, entity_id, event_type, tenant_id, limit, async_req=True)
        >>> result = thread.get()
    ...
    def get_events_using_get1(self, entity_type, entity_id, tenant_id, limit, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_events_using_get1(entity_type, entity_id, tenant_id, limit, async_req=True)
        >>> result = thread.get()
    ...
    def get_events_using_get1_with_http_info(self, entity_type, entity_id, tenant_id, limit, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_events_using_get1_with_http_info(entity_type, entity_id, tenant_id, limit, async_req=True)
        >>> result = thread.get()
