...
class HttpIntegrationControllerApi(object):
    ...
    def process_request_using_post(self, body, request_headers, routing_key, suffix, **kwargs):  # noqa: E501
        """processRequest  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.process_request_using_post(body, request_headers, routing_key, suffix, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.process_request_using_post_with_http_info(body, request_headers, routing_key, suffix, **kwargs)  # noqa: E501
        else:
            (data) = self.process_request_using_post_with_http_info(body, request_headers, routing_key, suffix, **kwargs)  # noqa: E501
            return data

    def process_request_using_post_with_http_info(self, body, request_headers, routing_key, suffix, **kwargs):  # noqa: E501
        """processRequest  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.process_request_using_post_with_http_info(body, request_headers, routing_key, suffix, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'request_headers', 'routing_key', 'suffix']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('suffix' not in params or
            ...
            raise ValueError("Missing the required parameter `suffix` when calling `process_request_using_post`")  # noqa: E501
    ...
    def process_request_using_post1(self, body, request_headers, routing_key, suffix, **kwargs):  # noqa: E501
        """processRequest  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.process_request_using_post1(body, request_headers, routing_key, suffix, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.process_request_using_post1_with_http_info(body, request_headers, routing_key, suffix, **kwargs)  # noqa: E501
        else:
            (data) = self.process_request_using_post1_with_http_info(body, request_headers, routing_key, suffix, **kwargs)  # noqa: E501
            return data

    def process_request_using_post1_with_http_info(self, body, request_headers, routing_key, suffix, **kwargs):  # noqa: E501
        """processRequest  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.process_request_using_post1_with_http_info(body, request_headers, routing_key, suffix, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `process_request_using_post1`")  # noqa: E501
        # verify the required parameter 'request_headers' is set
        if ('request_headers' not in params or
                params['request_headers'] is None):
            raise ValueError("Missing the required parameter `request_headers` when calling `process_request_using_post1`")  # noqa: E501
        # verify the required parameter 'routing_key' is set
        if ('routing_key' not in params or
                params['routing_key'] is None):
