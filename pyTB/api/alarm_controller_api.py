...
class AlarmControllerApi(object):
    ...
    def get_alarms_using_get(self, entity_type, entity_id, limit, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_alarms_using_get(entity_type, entity_id, limit, async_req=True)
        >>> result = thread.get()
    ...
    def get_alarms_using_get_with_http_info(self, entity_type, entity_id, limit, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_alarms_using_get_with_http_info(entity_type, entity_id, limit, async_req=True)
        >>> result = thread.get()
